...
try:
    ...
    IPEX_AVAILABLE = True
    print("✅ [Qwen3-TTS] Intel Extension for PyTorch (IPEX) loaded - XPU optimizations enabled")
except ImportError:
...
try:
    ...
    print(f"✅ [Qwen3-TTS] CPU multi-core optimization enabled - Using {CPU_CORES} cores")
except Exception as e:
    print(f"⚠️ [Qwen3-TTS] CPU threading setup warning: {e}")
...
def optimize_cpu_performance():
    ...
    try:
        ...
        print(f"⚠️ [Qwen3-TTS] CPU optimization warning: {e}")
...
def unload_cached_model(cache_key=None):
    ...
    if hasattr(torch, "xpu") and torch.xpu.is_available():
        try:
            ...
            print(f"⚠️ [Qwen3-TTS] XPU cleanup warning: {e}")
    ...
    if torch.cuda.is_available():
        try:
            ...
            print(f"⚠️ [Qwen3-TTS] CUDA cleanup warning: {e}")
...
def load_qwen_model(
    ...
    # CPU optimization
    if device == "cpu":
        print(f"🔧 [Qwen3-TTS] CPU mode detected - Optimizing for {CPU_CORES} cores...")
        optimize_cpu_performance()
        dtype = torch.float32
        print("🔧 [Qwen3-TTS] CPU precision set to float32 for compatibility")
...
class SaveVoiceNode:
    ...
    def save(self, voice_clone_prompt, filename, audio=None, ref_text: str = ""):
        ...
        try:
            ...
            print(f"✅ [Qwen3-TTS] Voice prompt features saved to: {path_qvp}")
        except Exception as e:
            print(f"❌ [Qwen3-TTS] Failed to save voice prompt: {e}")
        ...
        try:
            ...
            print(f"❌ [Qwen3-TTS] Failed to save metadata JSON: {e}")
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "VoiceDesignNode": "🎨 Qwen3-TTS VoiceDesign",
    "VoiceCloneNode": "🎭 Qwen3-TTS VoiceClone",
    "CustomVoiceNode": "🎵 Qwen3-TTS CustomVoice",
    "VoiceClonePromptNode": "💾 Qwen3-TTS VoiceClonePrompt",
    "RoleBankNode": "📇 Qwen3-TTS RoleBank",
    "DialogueInferenceNode": "💬 Qwen3-TTS DialogueInference",
    "SaveVoiceNode": "💾 Qwen3-TTS SaveVoice",
    "LoadSpeakerNode": "🎙️ Qwen3-TTS LoadSpeaker",
}
